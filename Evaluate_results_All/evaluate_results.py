...
csv_input_path = r'/home/luis/Dropbox/04_Audio_Perfomance_Evaluation/AWS_speech_recognition/Testset_440_checked_aws.csv'
...
log_result_path = path_this_file + '/' + 'CER_results_' + input_csv_name + '_' + lang_mode + '.txt'
...
for index, row in df_all.iterrows():
    ...
    my_pred, cnt_empty_preds = std_my_phrases(str(row[lang_mode]))

    my_prob = cer(my_gt, my_pred)

    prob_phonemes = cer_phonemes(my_gt, my_pred, lang_mode)
...
msg = "Phonemes: {}".format(1 - cer_avg_phonemes)
log_message(msg, log_result_path, 'a')

msg = "Empty predictions: {}".format(cnt_empty_preds)
log_message(msg, log_result_path, 'a')
