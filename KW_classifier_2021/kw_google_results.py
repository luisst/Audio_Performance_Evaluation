...
if __name__ == "__main__":       
    # read CSV
    csv_input_path = r'/home/luis/Dropbox/CVpaper/aolme_testset_spanish_results.csv'
    ...
    for index, row in df_all.iterrows():
        my_gt = std_my_phrases(str(row['GT_column']))
        my_pred_spanish = std_my_phrases(str(row['spanish']))
